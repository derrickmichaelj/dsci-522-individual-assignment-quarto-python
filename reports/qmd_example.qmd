...
```{python}
#| label: tbl-horses-sd
#| tbl-cap: Standard Deviation of Historical Horse Populations
...
Additionally, note that in @tbl-horses-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse1.
